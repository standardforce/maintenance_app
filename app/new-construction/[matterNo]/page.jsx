...
export default function NewConstruction() {
  ...
  useEffect(() => {
    async function fetchConstructionData() {
      ...
      try {
        const response = await fetch(`/api/construction/${matterNo}`, {
          method: "GET",
        ...
        form.reset({
          ...
          sixMonths: data.sixMonths || false,
          oneYear: data.oneYear || false,
          threeYears: data.threeYears || false,
          tenYears: data.tenYears || false,
          confirmNotifications: false,
        });
      } catch (error) {
  ...
  const onSubmit = async (values) => {
    setLoading(true);
    try {
      const url = matterNo ? `/api/construction/${matterNo}` : "/api/submitConstruction";
      const method = matterNo ? "PUT" : "POST";
      ...
      alert(matterNo ? "Update successful!" : "Registration successful!");
      router.push("/success");
    } catch (error) {
